 ...
 * @author michellanet
 */
@WebServlet(name = "EditVideoView", urlPatterns = {"/EditVideoView"})
public class EditVideoView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (port.isSessionAuthorized()) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<title>Edit Video</title>");
                ...
                out.println("<h3 class='mb-3'>Edit Video</h3>");
                out.println("</div>");
                out.println("<div class='col-4'>");
                ...
                out.println("<form action='EditVideo' method='post' enctype='multipart/form-data'>");
                ...
                out.println("<input type='text' class='form-control' name='genre' placeholder='Comedy' required='true' "
                        + "value=" + video.getGenre() + ">");
                out.println("</div>");
    ...
    out.println("</div>");
                ...
                out.println("<input type='text' class='form-control' name='actorFN' placeholder='Jim' required='true' "
                        + "value=" + video.getStarActorFk().getFirstname() + ">");
                out.println("</div>");
                out.println("<div class='form-group mb-4'>");
                out.println("<label for='actorLN'>Last Name</label>");
                out.println("<input type='text' class='form-control' name='actorLN' placeholder='Carey' required='true' "
                        + "value=" + video.getStarActorFk().getLastname() + ">");
                out.println("</div>");

//set radio button
                String movie = "";
                String show = "";
                if (video.getType().toLowerCase().equals("movie")) {
                    movie = "checked";
                    show = "";
                } else {
                    movie = "";
                ...
                out.println("<input class='form-check-input' type='radio' name='videoType' id='movie' value='Movie' "
                        + "" + movie + ">");
                ...
                out.println("<input type='text' class='form-control' name='year' style='width:100px' pattern='\\d+' placeholder='2020' required='true' "
                        + "value=" + video.getYear() + ">");
                out.println("</div>");
